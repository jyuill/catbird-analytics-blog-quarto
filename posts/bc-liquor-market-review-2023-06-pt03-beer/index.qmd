...
We'll start with an annual overview across all categories and then look at trends for individual categories further down below.

```{r, annual}
trend_yr <- lmr_data %>% group_by(year, fyr) %>% summarize(
